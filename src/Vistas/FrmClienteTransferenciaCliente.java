 ...
 * @author Usuario
 */
public class FrmClienteTransferenciaCliente extends javax.swing.JPanel {
 private CuentaBancariaServicio cbs = new CuentaBancariaServicio();
    /**
     * Creates new form FrmClienteTransferenciaCliente
     */
    public FrmClienteTransferenciaCliente() {
        initComponents();
        txtCuentaDebi.setText(String.valueOf(Sesion.getCuenta().getPersona().getCuentaBancaria().getNroCuenta()));
        txtCuentaDebi.setEnabled(false);
                ...
                if (cbs.obtenerCuentaBancaria(Integer.parseInt(txtCuentaDep.getText())) != null) {
                    if (cbs.obtenerCuentaBancaria(Integer.parseInt(txtCuentaDebi.getText())).getSaldo() >= Double.parseDouble(txtMonto.getText())) {
                        if (!(txtCuentaDebi.getText().equals(txtCuentaDep.getText()))) {
                            ...
                            limpiar();
                            UtilidadesComponente.mensajeOK("OK","La operacion se realizo con exito");
                        } else {
                            UtilidadesComponente.mensajeError("Error", "Error esta intentando depositar en su propiar cuenta ");
                        }
                    } else {
    ...
    private void initComponents() {
        ...
        add(pnlAsignar);
        pnlAsignar.setBounds(0, 0, 720, 500);
